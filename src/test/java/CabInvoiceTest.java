...
public class CabInvoiceTest {
    ...
    public void testGenerateInvoice() {
        ...
        Assert.assertEquals(44, invoice.generateInvoice(new Rides(4, 4)));
    }
    ...
    public void testGenerateInvoice_getMin() {
        ...
        Assertions Assert = null;
        Assert.assertEquals(5, invoice.generateInvoice(new Rides(0.2, 1)));
    }
    /*
    ...
    public void whenGivenMultipleRidesShouldReturnTotalFare() {
        ...
        Assertions Assert = null;
        Assert.assertEquals(50, totalFare);
    }
    @Test
